...
**Tech stack:** Python 3.12+, OpenAI-compatible API, Thompson sampling, AST-based sandbox. 385 tests, mypy strict, full CI.
...
**Tweet 7 (CTA):**
Open source, MIT licensed. 385 tests, mypy strict, full CI.
